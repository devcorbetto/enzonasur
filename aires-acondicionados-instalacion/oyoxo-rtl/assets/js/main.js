        ...
        sliderActivations: {
            ...
            productsSliderActivation: function () {
                $('.tm-products-slider').slick({
                    ...
                    slidesToScroll: 2,
                    arrows: true,
                    prevArrow: '<button class="tm-slider-arrows-prev"><i class="ion-ios-arrow-thin-right"></i></button>',
                    nextArrow: '<button class="tm-slider-arrows-next"><i class="ion-ios-arrow-thin-left"></i></button>',
                    dots: false,
                    rtl: true,
                    responsive: [{
                            breakpoint: 1201,
